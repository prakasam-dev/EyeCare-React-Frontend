...
const Specialists = () => {
  ...
  return (
    <section id='specialists' className='py-20 overflow-hidden bg-gradiant-to-r from-pink-100 bg-purple-100'>
        <div className='container mx-auto px-4'>
            <header data-aos='fade-up' data-aos-delay='400' className='text-center mb-16 relative'>
                ...
                <p className='text-lg text-gray-600  max-w-4xl mx-auto relative z-10'>
                    Eye experts are specialist who diagnose and treat vision problems and eye disease.They conduct eye exams,
                    prescribe glasses or contact lenses, and offer medical or surgical treatments.Their role is crusial in maintaining
                    good eye health and preventing vission loss.Regular check-ups with an eye expert help detect eye issues early for better
                    outcomes.
                </p>
                <span className='absolute -bottom-6 right-1/4 w-16 h-16 rounded-full bg-purple-300
                ...
                <div className='p-6 relative -mt-10'>
                    <div className='bg-pink-200 rounded-lg shadow-md p-6'>
                        <header>
                            ...
                            <figure className='absolute -top-6 left-6 text-white bg-pink-700 p-3 rounded-full shadow-lg'
                            aria-label='true'>
            ...
            <aside data-aos='fade-up' data-aos-delay='500' className='bg-gradient-to-r from-pink-100 to-purple-100
            rounded-2xl p-8 md:p-12 text-center realative overflow-hidden'>
                <span className='absolute -top-20 -left-20 w-40 h-40 rounded-full bg-pink-300 opacity-20'
                aria-hidden='true'>
                </span>
                <span className='absolute -bottom-20 -right-20 w-60 h-60 rounded-full bg-pink-300 opacity-20'
                aria-hidden='true'>
                </span>
                <div className='relative z-10'>
                    <h3 className='text-2xl md:text-3xl font-bold text-gray-800 mb-6'>
                        Ready to consult with our Specialists</h3>
                        <p className='text-lg text-gray-600 mb-8 max-w-2xl mx-auto'>
                            Ready to consult our specialists ? Get expert eye care and personalized treatment for all your vision needs.
                        </p>
