      ...
      <div className="container mx-auto px-4">
        ...
        >
          <figure className="lg:w-5/12 relative">
            ...
            <span
              className="hidden lg:block absolute -bottom-12 -left-8 w-40 h-40 rounded-full
           bg-pink-500 opacity-20 z-0"
              aria-hidden="true"
            ></span>
            <span
              className="hidden lg:block absolute -top-12 -right-8 w-50 h-50 rounded-full
          ...
          <div data-aos="fade-up" data-aos-delay="500" className="lg:w-7/12">
            <header>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6">
                About
                <span className="text-pink-600"> Divine Vision Centre</span>
              </h2>
              <p className="text-lg text-gray-600 mb-6">
                At vision care,we are dedicated to providing comprehensive eye
                care solutions with precision and compassion. From routine eye
                checkups to advanced treatments for complex conditions,your
                vision health is our top priority. With stage-of-the-art
                technology and expert ophthalmologists,we ensure clearer vision
                for a brighter feature.
              </p>
            </header>
        ...
        <aside className="mt-20 bg-white rounded-2xl p-8 md:p-12 shadow-lg relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <blockquote className="text-lg text-gray-700 mb-6">
              Our mission is to deliver exceptional eye care that enhances
              vision,improves lives,and builds trust with every patient we
              serve. We strive to combine advanced technology,expert
              knowledge,and compassionate service in every step of care. "Your
              mission is our mission - because seeing the world clearly should
              never be a luxury"
            </blockquote>
