    ...
    <footer className="bg-gray-900 text-white pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <section>
            <h3
              className="text-xl font-bold mb-6 after:content-[] after:absolute after:left-0
          ...
          <address>
            <h3
              className="text-xl font-bold mb-6 relative pb-2 after:absolute after:content-[]
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between">
            <div className="mb-6 lg:mb-0 lg:mr-8">
              ...
              <p className="text-gray-400">
                Get updates on special offers and eye-care tips
              </p>
            </div>
            <form
        ...
        <footer className="pt-8 border-gray-800 flex flex-col md:flex-row justify-between items-baseline">
          <p className="text-gray-500 text-sm mb-4 md:mb-0">
            &copy;{new Date().getFullYear()} Divine vision centre. All rights
            reserved.
          </p>
            ...
            <ul className="flex space-x-6">
              {legalLinks.map((link, index) => (
                <li key={index}>
                  <Link
                    to={link.text}
                    className="text-gray-500 hover:text-pink-500 text-sm ytransition"
                  >
                    {link.text}
                  </Link>
                </li>
